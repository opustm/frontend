...
export const descriptions = {
    pages: {
        ...
        Login: {
            iconMessages: [
                ['Create Teams', <Icon.FiTarget size={30} style={{marginTop: '2px', marginRight: '10px'}}/>],
                ['Send Announcements', <Icon.FiRss size={30} style={{marginTop: '2px', marginRight: '10px'}}/>],
                ['Meet with Colleagues', <Icon.FiCalendar size={30} style={{marginTop: '2px', marginRight: '10px'}}/>],
                ['View your Contacts', <Icon.FiBook size={30} style={{marginTop: '2px', marginRight: '10px'}}/>],
                ['Customize your Profile', <Icon.FiUser size={30} style={{marginTop: '2px', marginRight: '10px'}}/>],
            ]
        }
    },
    apps:"",
