...
export default function App() {
  ...
  let teamViewUpdate = teamToRemove => {
    let newTeams = userTeams.filter(team => {
      return team.id !== teamToRemove;
    });
    setUserTeams(newTeams);
  };
      ...
      <Switch>
        <Route path="/login">
          {loggedIn ? (
            ...
            <Login loggedIn={loggedIn} onLoggedInChange={handleLoginChange} />
          )}
        </Route>
        ...
        {loggedIn ? (
          <div className={sidebarToggled ? 'page sidebar-toggled' : 'page'}>
            ...
            />
            <Route
              path="/calendar/:teamUsername?"
              exact
              component={props => {
                return <Calendar {...props} userInfo={userData} />;
              }}
            />
            <Route
              path="/teams"
              exact
              component={props => {
                return <Teams userInfo={userData} updateTeams={updateTeams} />;
              }}
            />
            <Route
              path="/contacts"
              exact
              component={() => {
                return <Contacts userInfo={userData} />;
              }}
            />
            <Route
              path="/announcements/:teamUsername?"
              exact
              component={props => {
                return <Announcements {...props} userInfo={userData} />;
              }}
            />
            <Route
              path="/user/:username"
              component={props => {
                return <Profile {...props} userInfo={userData} />;
              }}
            />
            <Route
              path="/teams/:teamUsername"
              exact
              component={props => {
                return (
                  <TeamView userInfo={userData} updateTeams={teamViewUpdate} />
                );
              }}
            />
          </div>
